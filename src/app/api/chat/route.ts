...
- Email: Emanuelrigo.ER@gmail.com
    ...
    return NextResponse.json(
      {
        ...
        isFallback: true,
        text:
          "¡Hola! Estoy teniendo problemas técnicos momentáneos, pero podés contactar a Emanuel en Emanuelrigo.ER@gmail.com",
      },
      { status: 500 }
    );
  }
...
function getLocalFallbackReply(query: string): string {
  ...
  if (
    ...
    return "Podés contactar a Emanuel en: Emanuelrigo.ER@gmail.com";
  }
  ...
  if (
    ...
    return `Proyectos destacados: MovieList y Clinic Lab.`;
  }
  ...
  if (
    ...
    return `Trabajo con React, Next.js, Node.js, TypeScript y más.`;
  }
